...
public enum Alliance {
    ...
    WHITE() {
        ...
        @Override
        public Player choosePlayerByAlliance(final WhitePieces whitePlayer,
                                             final BlackPieces blackPlayer) {
            return whitePlayer;
        }
    ...
    public abstract Player choosePlayerByAlliance(final WhitePieces whitePlayer, final BlackPieces blackPlayer);
