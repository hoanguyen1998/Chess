...
import com.chess.engine.player.BlackPieces;
import com.chess.engine.player.Player;
import com.chess.engine.player.WhitePieces;
...
public final class Board {
    ...
    private final WhitePieces whitePlayer;
    private final BlackPieces blackPlayer;
    ...
    private Board(final Builder builder) {
        ...
        this.whitePlayer = new WhitePieces(this, whiteStandardMoves, blackStandardMoves);
        this.blackPlayer = new BlackPieces(this, whiteStandardMoves, blackStandardMoves);
    ...
    public WhitePieces whitePlayer() {
        return this.whitePlayer;
    }

    public BlackPieces blackPlayer() {
