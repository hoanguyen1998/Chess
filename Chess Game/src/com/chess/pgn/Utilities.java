...
import static com.chess.game.board.Move.MoveFactory;
...
public class Utilities {
    ...
    public static void persistPGNFile(final File pgnFile) throws IOException {
        ...
        try (final BufferedReader br = new BufferedReader(new FileReader(pgnFile))) {
            String line;
            GameTags.TagsBuilder tagsBuilder = new GameTags.TagsBuilder();
            ...
            while((line = br.readLine()) != null) {
                if (!line.isEmpty()) {
                    if (isTag(line)) {
                        ...
                        tagsBuilder = new GameTags.TagsBuilder();
                    }
                    else {
    ...
    public static List<String> processMoveText(final String gameText) throws ParseException {
